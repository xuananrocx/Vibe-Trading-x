      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b">
          <div className="flex items-center gap-2">
            <span className="text-sm font-semibold">{t("chat.pineScript")}</span>
            <span className="text-xs text-muted-foreground">{t("chat.strategyPine")}</span>
          </div>
