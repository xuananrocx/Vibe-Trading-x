...
export function Home() {
  ...
  const FEATURES = [
    { icon: Bot, title: t("home.features.aiAgent.title"), desc: t("home.features.aiAgent.desc") },
    { icon: BarChart3, title: t("home.features.builtinBacktest.title"), desc: t("home.features.builtinBacktest.desc") },
    { icon: Zap, title: t("home.features.realtimeStreaming.title"), desc: t("home.features.realtimeStreaming.desc") },
    { icon: UserCircle2, title: t("home.features.strategyReplay.title"), desc: t("home.features.strategyReplay.desc") },
  ];
